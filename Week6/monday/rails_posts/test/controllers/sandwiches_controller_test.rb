...
class SandwichesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sandwich" do
    assert_difference('Sandwich.count') do
      post sandwiches_url, params: { sandwich: { filling: @sandwich.filling, name: @sandwich.name, price: @sandwich.price } }
    end
  ...
  test "should update sandwich" do
    patch sandwich_url(@sandwich), params: { sandwich: { filling: @sandwich.filling, name: @sandwich.name, price: @sandwich.price } }
